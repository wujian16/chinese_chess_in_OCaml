Our team: Wenting Li (wl439), Eric Mei (em674), Yinan Wen (yw654) and Jian Wu (jw926)

First of all, we make our github repository to be public now, and if you cannot read this document, please
follow this link https://github.com/wujian16/CS3110_Project/tree/master/src to
find the readme.txt.

Second, to fully appreciate our awesome AI, we would like to invite (request) graders with
some prior knowledge on Chinese Chess.
